...
6. **Generate `root_cause_analysis.json`** — **LLM summarization with structured tool support**. After multi-source fusion and knowledge-graph validation, produce a structured object with these fields: `conclusion`, `analysis`, `event_chain`, `propagation_chain`, `source_clues`, `solution`.
