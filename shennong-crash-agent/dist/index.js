...
- \`crash_feature_info\`\uFF1A\u811A\u672C/\u5DE5\u5177\u76F4\u63A5\u751F\u6210\u3002\u5FC5\u987B\u4E25\u683C\u4F18\u5148\u4ECE MCP \u5DE5\u5177 \`analyze_crash\` \u7684\u8F93\u51FA \`crash_features\` \u5B57\u6BB5\u4FDD\u5B58\uFF0C\u683C\u5F0F\u4FDD\u6301\u539F\u6837\uFF0C\u7981\u6B62 LLM \u6539\u5199\u6216\u91CD\u65B0\u603B\u7ED3\uFF1A
  ...
  - \`raw_crash_log\`\uFF1A\u4ECE\u539F\u59CB\u65E5\u5FD7\u6587\u4EF6\u9010\u5B57\u63D0\u53D6\u5B8C\u6574\u8FDE\u7EED\u7684\u5D29\u6E83\u65E5\u5FD7\u6BB5\uFF08\u4ECE\u5D29\u6E83\u9996\u884C\u5230 \`Code:\` \u673A\u5668\u7801\u884C\u6B62\uFF09\uFF1B\`log_features\`\uFF1A\u4ECE\u65E5\u5FD7\u63D0\u70BC related_ref / related_errors / repeated / other \u4E09\u7C7B\u5F02\u5E38\uFF0C\u6BCF\u6761\u6807\u6CE8\u6765\u6E90\u6587\u4EF6\u3001\u884C\u53F7\u4E0E relevance \u76F8\u5173\u6027\u3002
  - \u5F53 \`analyze_crash\` \u672A\u8FD4\u56DE\u67D0\u9879\u65F6\uFF0C\u624D\u53EF\u4F7F\u7528 witty-log-detection / \u57FA\u7840\u547D\u4EE4 / vmcore-analysis \u7684\u7ED3\u679C\u4F5C\u4E3A\u8865\u5145\uFF0C\u5E76\u5728 \`workflow_trace\` \u4E2D\u8BF4\u660E\u6765\u6E90\u3002
- \`root_cause_analysis\`\uFF1ALLM \u57FA\u4E8E\u4E0A\u4E0B\u6587\u603B\u7ED3\u751F\u6210\u3002\u5728\u5185\u90E8/\u793E\u533A\u6848\u4F8B\u3001\u5D29\u6E83\u7279\u5F81\u3001\u65E5\u5FD7\u68C0\u6D4B\u3001vmcore \u5206\u6790\u3001\u6E90\u7801\u5206\u6790\u7B49\u591A\u6E90\u8BC1\u636E\u57FA\u7840\u4E0A\uFF0C\u7EFC\u5408\u751F\u6210 \`conclusion\`\u3001\`overview_brief\`\u3001\`trigger_scenario\`\u3001\`standard_solution\`\u3001\`temporary_workaround\`\u3001\`event_scene\`\u3001\`propagation_chain\`\u3001\`reasoning_flow\`\u3001\`deep\` \u7B49\u5B57\u6BB5\uFF08\u7ED3\u6784\u4EE5 \`skills/crash-report-generator/schemas/crash-report-schema.json\` \u4E3A\u51C6\uFF09\u3002
    ...
    config: async (config) => {
      config.agent = {
        ...
        shennong: {
          mode: "primary",
          prompt,
          description: "Shennong\uFF08\u795E\u519C\uFF09\u5185\u6838/\u786C\u4EF6\u5B95\u673A\u8BCA\u65AD\u4E3B Agent\uFF1A\u8C03\u7528 crash-feature-matcher\u3001witty-log-detection MCP \u4E0E vmcore-analysis\u3001crash-report-generator \u7B49\u6838\u5FC3\u80FD\u529B\uFF0C\u81EA\u52A8\u5316\u5B8C\u6210\u6839\u56E0\u8BCA\u65AD\u5E76\u8F93\u51FA\u6807\u51C6\u5316 JSON/HTML \u62A5\u544A\u3002",
          skills: [
