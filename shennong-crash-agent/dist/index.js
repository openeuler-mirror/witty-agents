// src/agents/identity-constraints.ts
var SHENNONG_IDENTITY_CONSTRAINTS = `<system-reminder>
...
- \u5185\u90E8\u6848\u4F8B\u4F18\u5148\u4E8E\u793E\u533A\u6848\u4F8B\uFF1B
- \u5BF9\u51B2\u7A81\u4FE1\u606F\u8FDB\u884C\u6D88\u89E3\uFF0C\u751F\u6210\u6839\u56E0\u6458\u8981\uFF1B
- \u8F93\u51FA simplified_root_cause (\u7B80\u5316\u6839\u56E0)\u3001detailed_root_cause (\u8BE6\u7EC6\u6839\u56E0+\u4EE3\u7801)\u3001solution (\u89E3\u51B3\u65B9\u6848)\u3001crash_chains (\u5D29\u6E83\u94FE\u8DEF)\u3001analysis_notes (\u5206\u6790\u5907\u6CE8)\u3002
...
5. \`diagnosis_repair_result.json\`\uFF1A**\u811A\u672C/\u5DE5\u5177\u76F4\u63A5\u751F\u6210**\u3002\`internal_kernel_result\` \u4E0E \`community_kernel_result\` \u5206\u522B\u53D6\u81EA \`query_knowledge\` / \`query_cases\` / \`query_community_cases\` \u8FD4\u56DE\u6570\u7EC4\u7684\u539F\u59CB JSON\uFF0C\u7981\u6B62\u6539\u5199\uFF1B
6. \`root_cause_analysis.json\`\uFF1A**LLM \u57FA\u4E8E\u4E0A\u4E0B\u6587\u603B\u7ED3\u751F\u6210**\u3002\u5728\u5DF2\u6709\u591A\u6E90\u8BC1\u636E\uFF08\u57FA\u7EBF\u3001\u5D29\u6E83\u7279\u5F81\u3001\u5185\u90E8/\u793E\u533A\u6848\u4F8B\u3001\u65E5\u5FD7\u68C0\u6D4B\u3001\u6E90\u7801\u5206\u6790\uFF09\u57FA\u7840\u4E0A\uFF0C\u4EBA\u5DE5\u7EFC\u5408\u751F\u6210 simplified_root_cause (\u7B80\u5316\u6839\u56E0)\u3001detailed_root_cause (\u8BE6\u7EC6\u6839\u56E0+\u4EE3\u7801)\u3001solution (\u89E3\u51B3\u65B9\u6848)\u3001crash_chains (\u5D29\u6E83\u94FE\u8DEF)\u3001analysis_notes (\u5206\u6790\u5907\u6CE8)\uFF1B
...
\u4F7F\u7528 \`combine_report.py\` \u5408\u5E76\u6240\u6709\u5206\u7247\u4E3A\u5B8C\u6574 \`DiagnoseReport\` JSON\uFF1B\u518D\u4F7F\u7528 \`validate_report.py\` \u505A Schema \u5F3A\u6821\u9A8C\uFF0C\u901A\u8FC7\u540E\u624D\u8F93\u51FA\u3002
...
// src/agents/behavioral-summary.ts
var SHENNONG_BEHAVIORAL_SUMMARY = `## \u8F93\u51FA\u683C\u5F0F (Output Format)
...
- \`root_cause_analysis\`\uFF1ALLM \u57FA\u4E8E\u4E0A\u4E0B\u6587\u603B\u7ED3\u751F\u6210\u3002\u5728\u5185\u90E8/\u793E\u533A\u6848\u4F8B\u3001\u5D29\u6E83\u7279\u5F81\u3001\u65E5\u5FD7\u68C0\u6D4B\u3001vmcore \u5206\u6790\u3001\u6E90\u7801\u5206\u6790\u7B49\u591A\u6E90\u8BC1\u636E\u57FA\u7840\u4E0A\uFF0C\u7EFC\u5408\u751F\u6210 \`simplified_root_cause\`\u3001\`detailed_root_cause\`\u3001\`solution\`\u3001\`crash_chains\`\u3001\`analysis_notes\`\u3002
...
- **\u539F\u751F JSON \u9010\u503C\u76F4\u901A**\uFF1A\`diagnosis_repair_result\` \u4E2D\u7684\u5185\u90E8/\u793E\u533A\u6848\u4F8B\u5BF9\u8C61\u5FC5\u987B\u9010\u5B57\u6BB5\u3001\u9010\u503C\u590D\u5236\u81EA \`crash-feature-matcher\` \u8FD4\u56DE\u7684\u539F\u751F JSON\uFF0C\u7981\u6B62\u6539\u5199 value\u3001\u7981\u6B62\u91CD\u65B0\u603B\u7ED3\u3001\u7981\u6B62\u5B57\u6BB5\u540D\u6620\u5C04\u3001\u7981\u6B62\u6570\u503C\u5F52\u4E00\u5316\u6216\u7C7B\u578B\u8F6C\u6362\u3002
...
- \u4F60 **\u5FC5\u987B** \u5BF9 \`diagnosis_repair_result.internal_kernel_result\` \u548C \`diagnosis_repair_result.community_kernel_result\` **\u9010\u503C\u586B\u5165** \`crash-feature-matcher\` \u8FD4\u56DE\u7684\u539F\u751F JSON\uFF0C\u7981\u6B62\u6539\u5199\u4EFB\u4F55 value\u3001\u7981\u6B62\u5B57\u6BB5\u540D\u6620\u5C04\u3001\u7981\u6B62\u91CD\u65B0\u603B\u7ED3\u3001\u7981\u6B62\u5F52\u4E00\u5316/\u7C7B\u578B\u8F6C\u6362\uFF0C\u4FDD\u7559\u6240\u6709\u539F\u59CB\u5B57\u6BB5\u3002
...
// src/shared/env-prompt.ts
async function getSharedEnvPrompt() {
  return `## \u73AF\u5883\u53D8\u91CF\u8BF4\u660E

- \u5982\u914D\u7F6E\u4E86 DeepSeek/OpenAI \u7B49 LLM \u670D\u52A1\uFF0C\u8BF7\u901A\u8FC7\u73AF\u5883\u53D8\u91CF\u8BFB\u53D6 API Key \u4E0E\u6A21\u578B\u4FE1\u606F\u3002`;
}

// src/shared/language-prompt.ts
function buildGlobalLanguageInstruction(outputLanguage) {
  if (outputLanguage === "zh") {
    return "## \u8BED\u8A00\u8981\u6C42\n\n\u6240\u6709\u81EA\u7136\u8BED\u8A00\u8F93\u51FA\u4F7F\u7528\u4E2D\u6587\u3002\u4EE3\u7801\u3001\u6587\u4EF6\u8DEF\u5F84\u3001\u547D\u4EE4\u884C\u8F93\u51FA\u4FDD\u6301\u539F\u6837\u3002";
  }
  return "## Language Requirement\n\nAll natural language output should be in English. Code, file paths, and command-line output should remain unchanged.";
}

// src/agents/system-prompt.ts
var SHENNONG_SYSTEM_PROMPT = `${SHENNONG_IDENTITY_CONSTRAINTS}
${SHENNONG_BEHAVIORAL_SUMMARY}`;
var SHENNONG_PERMISSION = {
  edit: "deny",
  bash: "allow",
  webfetch: "allow"
};
async function getShennongPrompt(model, outputLanguage = "zh") {
  void model;
...
// src/index.ts
var ShennongCrashAgentPlugin = async (_ctx) => {
  const prompt = await getShennongPrompt();
  return {
    config: async (config) => {
      config.agent = {
        ...config.agent,
        shennong: {
          mode: "primary",
          prompt,
          description: "Shennong (Kernel Crash Diagnosis) \u2014 \u5185\u6838\u5B95\u673A\u8BCA\u65AD\u4E3B Agent\u3002\u76F4\u63A5\u8C03\u7528 crash-feature-matcher MCP\u3001witty-log-detection MCP \u7B49\u6838\u5FC3\u80FD\u529B\u5B8C\u6210\u81EA\u52A8\u5316\u6839\u56E0\u8BCA\u65AD\u3002",
          skills: [
          ...
          permission: SHENNONG_PERMISSION,
          temperature: 0.1
        }
      };
    },
    event: async (input) => {
      ...
      if (process.env.SHENNONG_DEBUG) {
        console.log(`[ShennongCrashAgent] event: ${eventName}`);
      }
    }
  };
};
var index_default = ShennongCrashAgentPlugin;
export {
