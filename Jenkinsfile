pipeline {
    agent {
        docker {
            ...
            label 'built-in'
            args '--user 0:0 --cap-add SYS_ADMIN --cap-add NET_ADMIN --security-opt seccomp=unconfined -v /home/witty-agents-jenkins/cache/npm:/root/.npm -v /home/witty-agents-jenkins/cache/pip:/root/.cache/pip -v /home/witty-agents-jenkins/ocr-model-cache:/home/witty-agents-jenkins/ocr-model-cache:ro'
        }
    }
